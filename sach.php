...
?>
    <tr>
        ...
        <td>
            <a href="index.php?page_layout=chitietsach&MaSach=<?= $row['MaSach']; ?>">
                <?= htmlspecialchars($row['TuaSach']); ?>
            </a>
        </td>

        <td>
            <img src="uploads/<?= $row['HinhAnh']; ?>" alt="">
        </td>

        <td><?= htmlspecialchars($row['TacGia']); ?></td>
        <td><?= number_format($row['GiaTri'], 0, ',', '.'); ?> đ</td>
        ...
        <td class="chucnang">
            <a class="btn" href="index.php?page_layout=capnhatsach&MaSach=<?= $row['MaSach']; ?>">
                Cập nhật
            </a>
            <a class="btn" href="xoasach.php?MaSach=<?= $row['MaSach']; ?>" 
